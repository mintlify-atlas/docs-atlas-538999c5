...
description: Solutions to common IHP development issues and error messages
---
...
<Accordion title="Solution: Fix the missing link">
  **Problem:**
...
<Accordion title="Solution: Fix binary cache">
  **Problem:**
...
<Accordion title="Solution: Update nix.conf">
  **Problem:**
...
<Accordion title="Solution: Stop Postgres processes">
  **Problem:**
...
<Accordion title="Solution: Add implicit parameter to type signature">
...
<Accordion title="Solution: Clear nix cache">
...
<Accordion title="Solution: Switch to WSL 2">
  **Problem:**

  When you run `ihp-new blog` to create a new project on a system using Ubuntu running on Windows Subsystem for Linux 1, you get an error like:
...
<Accordion title="Solution: Disable relation support">
  **Problem:**
...
<Accordion title="Solution: Include CA certificates in Docker image">
  **Problem:**
