...
description: Code naming standards and conventions for IHP applications to maintain consistency across projects
---
...
<Note>
PostgreSQL automatically folds unquoted identifiers to lowercase, so using consistent lowercase naming avoids confusion.
</Note>
