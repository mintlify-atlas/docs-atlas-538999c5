...
description: Replace Bootstrap with Tailwind CSS using the official CLI and JIT mode
---

## Introduction

While Bootstrap is the default CSS framework in IHP, you can also use IHP together with Tailwind CSS.
